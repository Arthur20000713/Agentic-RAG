...
- Sources：展示 `source_uri`、title、page、section_title。
- Tools：展示 API 返回的 `tools_used`。
- Measurement：提交 `/api/measurement/analyze`，展示 report、summary、abnormal_items 和 evidence。
- Debug JSON：展示最近一次 API 响应的原始 JSON。
- Debug Summary：展示 request_id、rag_mode、agent_path、safety、verifier。
