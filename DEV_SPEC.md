...
| V2.4 | Session Context 多轮追问 | DONE（D1-D6 已完成） | `python -m pytest tests/e2e/test_session_follow_up_flow.py` |
| V2.5 | 真实评测和交付材料 | IN_PROGRESS（E1-E4 已完成） | `python scripts/run_eval.py --mode fake` |
